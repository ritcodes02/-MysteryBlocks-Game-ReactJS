...
const GameplayScreen6 = ({ onCorrectAnswer, currentBackground }) => {
    ...
    >
      ...
      >
        ...
        <div className="z-10 flex flex-col px-12 items-center justify-center flex-1 mt-32 text-center">
          ...
          {/* Shape display squire */}
          <div className="w-24 h-24 bg-white mb-8 rounded-full"></div>
...
export default GameplayScreen6;
