...
const GameplayScreen2 = ({ onCorrectAnswer, currentBackground }) => {
  ...
  useEffect(() => {
    ...
    const initAudio = async () => {
      ...
      // Create background synth for gameplay screen - slightly more intense than home screen
      const synth = new Tone.PolySynth(Tone.Synth).toDestination();
      synth.volume.value = -12; // Lower volume

      // Create a more urgent pattern for gameplay - slightly different from home screen
      ...
      // Set timing slightly faster for gameplay
    ...
    >
      ...
      >
        ...
        <div className="z-10 flex flex-col px-12 items-center justify-center flex-1 mt-32 text-center">
          ...
          <div className="w-32 h-32 rounded-full bg-white mb-2"></div>
          ...
          <div className="grid grid-cols-3 gap-1 mb-8">
            {[...Array(9)].map((_, i) => (
              <div
                ...
                style={{
                  backgroundImage:
                    i === 0 ? `url(${MoonImg})` : `url(${patternImage})`,
                }}
              ></div>
            ))}
          </div>
...
export default GameplayScreen2;
